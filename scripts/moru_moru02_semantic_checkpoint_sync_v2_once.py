...
def patch_work_items():
    ...
    text = replace_once(text, anchor, insert, "moru01-lighting-insert")
    WORK.write_text(text)


def patch_source():
    text = SOURCE.read_text()
    heading = "## 10. Native lighting family + semantic authoring handoff — 2026-09-14"
    if heading in text:
        return
    section = """
...
def patch_registry():
    ...
    text = replace_once(text, old, new, "registry-status")
