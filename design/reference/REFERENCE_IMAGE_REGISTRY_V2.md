...
- Old Ginkgo OG-02: exact 768×768 source and immutable-alpha edge-corrected v4 candidate are persisted; design-side static source-quality QA PASS; Android runtime activation and physical-device outdoor readability remain separate gates. OG-03 remains blocked pending the same exact-source edge workflow.
